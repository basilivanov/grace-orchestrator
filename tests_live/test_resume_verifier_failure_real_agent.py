"""Live test: resume-verifier-failure — verifier replay resume scenario."""
...
def test_resume_verifier_failure(api_url, target_dir, source_dir):
    args = argparse.Namespace(
        scenario="resume-verifier-failure",
        timeout=600,
    ...
    assert runner.report.get("verifier_replays", 0) >= 1
