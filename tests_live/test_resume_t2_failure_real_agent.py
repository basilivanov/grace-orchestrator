"""Live test: resume-t2-failure — acceptance replay resume scenario."""
...
def test_resume_t2_failure(api_url, target_dir, source_dir):
    args = argparse.Namespace(
        scenario="resume-t2-failure",
        timeout=600,
    ...
    assert runner.report.get("acceptance_replays", 0) >= 1
