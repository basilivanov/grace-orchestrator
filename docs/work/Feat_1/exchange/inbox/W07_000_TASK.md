...
source_wave_spec: docs/work/Feat_1/waves/W07_WORKER_ERROR_HANDLING_RETRY_SEMANTICS.md
expected_submission: docs/work/Feat_1/exchange/inbox/W07_001_SUBMISSION.md
previous_wave_review: docs/work/Feat_1/exchange/outbox/W06_001_REVIEW.md
---

# Task: W07 — Worker Error Handling and Retry Semantics
...
`docs/work/Feat_1/exchange/outbox/W06_001_REVIEW.md`

When W07 is complete, create:

`docs/work/Feat_1/exchange/inbox/W07_001_SUBMISSION.md`
...
- retry/failure classification evidence;
- known limitations.
